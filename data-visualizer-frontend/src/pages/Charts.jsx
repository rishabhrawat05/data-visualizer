...
const ChartPage = () => {
    ...
    return (
        <div style={{height:'100vh', width:'100%', backgroundColor:'blue', color:'white', opacity:'0.9', margin:'0', padding:'0', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'space-around', overflow:'hidden'}}>
            <h1 style={{fontSize:'3em'}}>Data Visualization</h1>
            <label style={{ fontSize: "18px", marginBottom: "3vh" }}>
                Select number of rows:{" "}
                <select
                    value={rowLimit}
                    onChange={(e) => e.target.value === 0 ? setRowLimit(e.target.value) : setRowLimit(Number(e.target.value))}
                    style={{ padding: "0.1em", fontSize: "1em", outline: "none", borderRadius: "50px" }}
                >
